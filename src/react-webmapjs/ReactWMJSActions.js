import { REACTWMJSMAP_SERVICE_SET_INFORMATION,
  REACTWMJSMAP_SERVICE_SET_LAYERS,
  REACTWMJSMAP_SERVICE_LAYER_SET_STYLES,
  REACTWMJSMAP_LAYER_CHANGE_STYLE,
  REACTWMJSMAP_SERVICE_LAYER_SET_DIMENSIONS
} from './ReactWMJSActionTypes.js';
...
export const setDimensionsInformation = obj => ({ type: REACTWMJSMAP_SERVICE_LAYER_SET_DIMENSIONS, payload: obj });
